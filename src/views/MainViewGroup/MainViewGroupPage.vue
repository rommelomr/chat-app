  ...
  <ion-page class="newgroup-page">
    ...
    <ion-content :fullscreen="true">
      ...
      <div class="quote ion-padding">
        <h4 class="ion-text-wrap">" La vida es bueno y debemos vivirla, como es
          una de las personas mas " </h4>
      </div>
      ...
      <div class="multimedia ion-padding">
        ...
        <ion-row>
          <ion-col size="3">
            <div class="img-holder flex al-center jc-center">
              <img src="assets/imgs/icn-gallery.svg" alt="">
            </div>
          </ion-col>
          <ion-col size="3">
            <div class="img-holder flex al-center jc-center">
      ...
      <div class="section">
        ...
        <div class="contact-holder flex al-center jc-between">
          <h4>123456</h4>
          <div class="btn-holder flex al-center">
            <div class="btn ion-activatable flex al-center jc-center ripple-parent">
              <ion-icon src="assets/imgs/icn-time.svg" />
              <ion-ripple-effect type="bounded"></ion-ripple-effect>
            </div>

            <div class="btn ion-activatable flex al-center jc-center ripple-parent">
              <ion-icon src="assets/imgs/icn-call.svg" />
              <ion-ripple-effect type="bounded"></ion-ripple-effect>
            </div>

            <div class="btn ion-activatable flex al-center jc-center ripple-parent">
              <ion-icon src="assets/imgs/icn-video.svg" />
              <ion-ripple-effect type="bounded"></ion-ripple-effect>
            </div>
          </div>
        </div>
      ...
      <div class="last">
        <ion-item button lines="none" detail="false">
          <ion-icon src="assets/imgs/block.svg" slot="start"/>
          <ion-label>Bloquear usuario</ion-label>
        </ion-item>
      </div>
      <div class="seperator" style="margin-top: 0;">

      </div>

      <div class="last">
        <ion-item button lines="none" detail="false">
          <ion-icon src="assets/imgs/reporter.svg" slot="start"/>
