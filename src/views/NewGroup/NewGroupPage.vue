    ...
    <ion-header class="ion-no-border">
      <ion-toolbar>
        <ion-buttons slot="start">
          <ion-back-button defaultHref="newgroup1" mode="ios" text=""></ion-back-button>
        </ion-buttons>
        <ion-title>
          Nuevo grupo
        </ion-title>
      ...
      <div class="input-item">
        <ion-item lines="none">
          <div class="flex al-center jc-center" slot="start">
            <img src="assets/imgs/icn-group.svg" alt="">
          </div>
          <ion-input v-model="newConversationBody.conversation_name" placeholder="Nombre del grupo" />
        </ion-item>
      </div>
      <div class="input-item">
        <ion-item lines="none">
          <div class="flex al-center jc-center" slot="start">
            <img src="assets/imgs/icn-des.svg" alt="">
          </div>
          <ion-input v-model="newConversationBody.description" placeholder="Descripción del grupo" />
        </ion-item>
      </div>
     </div>
     <div class="avatar-list" v-if="users.length > 0">
        <div class="avatar-holder ion-text-center" v-for="(group, index) in users" :key="index">
          <ion-avatar>
      ...
      <ion-fab slot="fixed" vertical="bottom" horizontal="end" @click="senMessageIfEmptyConversation(newConversationBody)">
      <ion-fab-button >
