  ...
  <ion-page class="newgroup-page">
    ...
    <ion-content :fullscreen="true" class="ion-padding">
      <div class="avatar-list" v-if="selectedList.length > 0">
        <div class="avatar-holder ion-text-center" v-for="(group, index) in selectedList" :key="index" @click="pushOrRemoveObject(group)">
          <ion-avatar>
      ...
      <div class="the-list">
        <ion-item v-for="(group, index) in displayedGroupList" :key="index" @click="pushOrRemoveObject(group)">
          ...
          <ion-label>
            ...
            <p>{{ group.person.name??'' }} {{ group.person.last_name??'' }}</p>
          </ion-label>
        </ion-item>
      </div>
