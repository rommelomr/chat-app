...
import { IonActionSheet, IonAlert, IonAvatar, IonBackButton, IonBadge, IonButton, 
  IonButtons, IonCol, IonContent, IonFab, IonFabButton, IonFooter, 
  IonGrid, 
  IonHeader, IonIcon, IonInput, IonItem, IonLabel, IonModal, IonPage, IonPopover, IonRippleEffect, IonRow, IonSearchbar, IonSelect, IonSelectOption, IonTitle, IonToggle, IonToolbar, IonicVue } from '@ionic/vue';
